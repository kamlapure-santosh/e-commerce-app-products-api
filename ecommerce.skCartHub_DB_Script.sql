...
IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = 'skCartDb')
BEGIN
    -- Create the database
    CREATE DATABASE skCartDb;
END
ELSE
BEGIN
   DROP DATABASE skCartDb;
END
...
Alter table Product
Add ProductDescription NVARCHAR(250)
...
INSERT INTO Product (ProductName, Price, Quantity, CategoryId, ProductDescription)
VALUES ('Smartphone', 499.99, 100, 1, 'Smartphone');

INSERT INTO Product (ProductName, Price, Quantity, CategoryId, ProductDescription)
VALUES ('Laptop', 899.99, 50, 1, 'Laptop');

INSERT INTO Product (ProductName, Price, Quantity, CategoryId, ProductDescription)
VALUES ('4DV9 Mini Drone', 1899.19, 15, 1, '4DV9 Mini Drone');

INSERT INTO Product (ProductName, Price, Quantity, CategoryId, ProductDescription)
VALUES ('T-Shirt', 19.99, 200, 2, 'T-Shirt');

INSERT INTO Product (ProductName, Price, Quantity, CategoryId, ProductDescription)
VALUES ('Jeans', 39.99, 100, 2, 'Jeans');

INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (1, 'https://learnsmartcoding.blob.core.windows.net/products/images/1_SAMSUNG_Galaxy_S24_Ultra_Cell_Phone_512GB_AI_Smartphone.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (1, 'https://learnsmartcoding.blob.core.windows.net/products/images/3_SAMSUNG_Galaxy_S24_Ultra_Cell_Phone_512GB_AI_Smartphone.mp4');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (2, 'https://learnsmartcoding.blob.core.windows.net/products/images/1_SAMSUNG_Galaxy_S24_Ultra_Cell_Phone_512GB_AI_Smartphone.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (3, 'https://learnsmartcoding.blob.core.windows.net/products/images/1_4DV9_Mini_Drone_minidrone-1.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (3, 'https://learnsmartcoding.blob.core.windows.net/products/images/1_4DV9_Mini_Drone_minidrone-2.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (3, 'https://learnsmartcoding.blob.core.windows.net/products/images/1_4DV9_Mini_Drone_minidrone-3.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (4, 'https://learnsmartcoding.blob.core.windows.net/products/images/2_Dimur_Sweaters_for_Women_Trendy_Long_Sleeve_Shirts_Loose_Fit_Tunic_Tops_2023.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (4, 'https://learnsmartcoding.blob.core.windows.net/products/images/2_Dimur_Sweaters_for_Women_Trendy_Long_Sleeve_Shirts_Loose_Fit_Tunic_Tops_2023.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (5, 'https://learnsmartcoding.blob.core.windows.net/products/images/2_Dimur_Sweaters_for_Women_Trendy_Long_Sleeve_Shirts_Loose_Fit_Tunic_Tops_2023.jpg');
INSERT INTO ProductImage (ProductId, ImageUrl) VALUES (5, 'https://learnsmartcoding.blob.core.windows.net/products/images/2_Dimur_Sweaters_for_Women_Trendy_Long_Sleeve_Shirts_Loose_Fit_Tunic_Tops_2023.jpg');
